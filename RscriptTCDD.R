...
ggsave(filename = "AFR_TCDD_incidence.jpeg", AFR,dpi = 600,width = 17,height = 8)
...
AMR
ggsave(filename = "AMR_TCDD_incidence.jpeg", AMR,dpi = 600,width = 17,height = 8)
...
EMR <- ggplot(Incidenceval2, aes(x = as.factor(Year), y = incidenceper100kmean, fill = Location)) + 
  ...
  scale_x_discrete(drop = FALSE)
EMR
ggsave(filename = "EMR_TCDD_incidence.jpeg", EMR,dpi = 600,width = 17,height = 8)
...
EUR
ggsave(filename = "EUR_TCDD_incidence.jpeg", EUR,dpi = 600,width = 17,height = 8)
...
SEAR
ggsave(filename = "SEAR_TCDD_incidence.jpeg", SEAR,dpi = 600,width = 17,height = 8)
...
WPR
ggsave(filename = "WPR_TCDD_incidence.jpeg", WPR,dpi = 600,width = 17,height = 8)
...
ggsave(filename = "AFR_TCDD_concen.jpeg", AFR,dpi = 600,width = 17,height = 8)
...
AMR
ggsave(filename = "AMR_TCDD_concen.jpeg", AMR,dpi = 600,width = 17,height = 8)
...
EMR
ggsave(filename = "EMR_TCDD_concen.jpeg", EMR,dpi = 600,width = 17,height = 8)
...
EUR
ggsave(filename = "EUR_TCDD_concen.jpeg", EUR,dpi = 600,width = 17,height = 8)
...
SEAR
ggsave(filename = "SEAR_TCDD_concen.jpeg", SEAR,dpi = 600,width = 17,height = 8)
...
WPR
ggsave(filename = "WPR_TCDD_concen.jpeg", WPR,dpi = 600,width = 17,height = 8)
...
ggsave(filename = "AFR_TCDD_diet_concen.jpeg", AFR,dpi = 600,width = 17,height = 8)
...
AMR
ggsave(filename = "AMR_TCDD_diet_concen.jpeg", AMR,dpi = 600,width = 17,height = 8)
...
EMR
ggsave(filename = "EMR_TCDD_diet_concen.jpeg", EMR,dpi = 600,width = 17,height = 8)
...
EUR
ggsave(filename = "EUR_TCDD_diet_concen.jpeg", EUR,dpi = 600,width = 17,height = 8)
...
SEAR
ggsave(filename = "SEAR_TCDD_diet_concen.jpeg", SEAR,dpi = 600,width = 17,height = 8)
...
WPR
ggsave(filename = "WPR_TCDD_diet_concen.jpeg", WPR,dpi = 600,width = 17,height = 8)
